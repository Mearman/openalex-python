...
class WorkSchemaBiblio(BaseModel):
    """
    WorkSchemaBiblio
    """ # noqa: E501
    first_page: Optional[Any] = None
    issue: Optional[Any] = None
    last_page: Optional[Any] = None
    volume: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["first_page", "issue", "last_page", "volume"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if first_page (nullable) is None
        # and model_fields_set contains the field
        if self.first_page is None and "first_page" in self.model_fields_set:
            _dict['first_page'] = None
        ...
        # set to None if last_page (nullable) is None
        # and model_fields_set contains the field
        if self.last_page is None and "last_page" in self.model_fields_set:
            _dict['last_page'] = None
