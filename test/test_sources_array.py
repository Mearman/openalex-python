...
class TestSourcesArray(unittest.TestCase):
    """SourcesArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourcesArray:
        """Test SourcesArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourcesArray`
        """
        model = SourcesArray()
        if include_optional:
            return SourcesArray(
