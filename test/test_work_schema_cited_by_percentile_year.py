...
class TestWorkSchemaCitedByPercentileYear(unittest.TestCase):
    """WorkSchemaCitedByPercentileYear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkSchemaCitedByPercentileYear:
        """Test WorkSchemaCitedByPercentileYear
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkSchemaCitedByPercentileYear`
        """
        model = WorkSchemaCitedByPercentileYear()
        if include_optional:
            return WorkSchemaCitedByPercentileYear(
                max = None,
                min = None
            )
        else:
    ...
    def testWorkSchemaCitedByPercentileYear(self):
        """Test WorkSchemaCitedByPercentileYear"""
