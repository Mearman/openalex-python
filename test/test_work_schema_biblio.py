...
class TestWorkSchemaBiblio(unittest.TestCase):
    """WorkSchemaBiblio unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkSchemaBiblio:
        """Test WorkSchemaBiblio
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkSchemaBiblio`
        """
        model = WorkSchemaBiblio()
        if include_optional:
            return WorkSchemaBiblio(
                first_page = None,
                issue = None,
                last_page = None,
                volume = None
