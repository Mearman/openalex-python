...
class TestNgramMeta(unittest.TestCase):
    """NgramMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NgramMeta:
        """Test NgramMeta
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NgramMeta`
        """
        model = NgramMeta()
        if include_optional:
            return NgramMeta(
