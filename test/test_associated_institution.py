...
class TestAssociatedInstitution(unittest.TestCase):
    """AssociatedInstitution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssociatedInstitution:
        """Test AssociatedInstitution
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssociatedInstitution`
        """
        model = AssociatedInstitution()
        if include_optional:
    ...
    def testAssociatedInstitution(self):
        """Test AssociatedInstitution"""
