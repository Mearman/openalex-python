...
class TestFundersArray(unittest.TestCase):
    """FundersArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundersArray:
        """Test FundersArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundersArray`
        """
        model = FundersArray()
        if include_optional:
            return FundersArray(
