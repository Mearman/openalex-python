...
class TestAuthorsResponseSchema(unittest.TestCase):
    """AuthorsResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthorsResponseSchema:
        """Test AuthorsResponseSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthorsResponseSchema`
        """
        model = AuthorsResponseSchema()
        if include_optional:
    ...
    def testAuthorsResponseSchema(self):
        """Test AuthorsResponseSchema"""
