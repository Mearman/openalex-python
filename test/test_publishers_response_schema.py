...
class TestPublishersResponseSchema(unittest.TestCase):
    """PublishersResponseSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublishersResponseSchema:
        """Test PublishersResponseSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublishersResponseSchema`
        """
        model = PublishersResponseSchema()
        if include_optional:
            return PublishersResponseSchema(
                group_by = None,
    ...
    def testPublishersResponseSchema(self):
        """Test PublishersResponseSchema"""
