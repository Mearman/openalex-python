...
class TestAutoCompleteResultItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AutoCompleteResultItem:
        """Test AutoCompleteResultItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoCompleteResultItem`
        """
        model = AutoCompleteResultItem()
        if include_optional:
