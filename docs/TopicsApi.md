# openalex_api.TopicsApi

All URIs are relative to *https://api.openalex.org*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_domain_by_id**](TopicsApi.md#get_domain_by_id) | **GET** /domains/{id} | /domains/{id}
[**get_field_by_id**](TopicsApi.md#get_field_by_id) | **GET** /field/{id} | /fields/{id}
[**get_subfield_by_id**](TopicsApi.md#get_subfield_by_id) | **GET** /subfields/{id} | /subfields/{id}
[**get_topic_by_id**](TopicsApi.md#get_topic_by_id) | **GET** /topics/{id} | /topics/{id}
[**get_topics**](TopicsApi.md#get_topics) | **GET** /topics | /topics
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    api_instance = openalex_api.TopicsApi(api_client)
    id = None # object | 
    ...
    try:
        ...
        print("The response of TopicsApi->get_domain_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TopicsApi->get_domain_by_id: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TopicsApi->get_field_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TopicsApi->get_field_by_id: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TopicsApi->get_subfield_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TopicsApi->get_subfield_by_id: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TopicsApi->get_topic_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TopicsApi->get_topic_by_id: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TopicsApi->get_topics:\n")
        pprint(api_response)
    except Exception as e:
