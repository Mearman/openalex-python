...
[**get_random_work**](WorksApi.md#get_random_work) | **GET** /works/random | /works/random
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WorksApi->get_random_work:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorksApi->get_random_work: %s\n" % e)
```
