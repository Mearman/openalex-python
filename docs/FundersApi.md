...
[**get_random_funder**](FundersApi.md#get_random_funder) | **GET** /funders/random | /funders/random
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FundersApi->get_random_funder:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FundersApi->get_random_funder: %s\n" % e)
```
