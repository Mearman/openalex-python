...
------------- | ------------- | -------------
[**get_random_author**](RandomApi.md#get_random_author) | **GET** /authors/random | Get Random Author
[**get_random_concept**](RandomApi.md#get_random_concept) | **GET** /concepts/random | /concepts/random
[**get_random_funder**](RandomApi.md#get_random_funder) | **GET** /funders/random | /funders/random
[**get_random_institution**](RandomApi.md#get_random_institution) | **GET** /institutions/random | /institutions/random
[**get_random_publisher**](RandomApi.md#get_random_publisher) | **GET** /publishers/random | /publishers/random
[**get_random_source**](RandomApi.md#get_random_source) | **GET** /sources/random | /sources/random
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_author:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_author: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_concept:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_concept: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_funder:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_funder: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_institution:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_institution: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_publisher:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_publisher: %s\n" % e)
```
...
with openalex_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RandomApi->get_random_source:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RandomApi->get_random_source: %s\n" % e)
```
