...
from openalex_api.api_client import ApiClient, RequestSerialized
...
class OpenAlexApi:
    ...
    def get_author(
        ...
        user_agent: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
    ...
    def get_work(
        self,
        id: Annotated[str, Field(strict=True, description="The id of the work to retrieve")],
        select: Optional[List[StrictStr]] = None,
        user_agent: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
        _request_timeout: Union[
