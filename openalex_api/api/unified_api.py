...
class UnifiedApi:
    ...
    def get_autocomplete_funders(
        ...
        _param = self._get_autocomplete_funders_serialize(
            q=q,
            user_agent=user_agent,
            mailto=mailto,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_autocomplete_funders_with_http_info(
        self,
        q: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
    ...
    @validate_call
    def get_autocomplete_funders_without_preload_content(
        self,
        q: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
    ...
    def _get_autocomplete_funders_serialize(
        self,
        q,
        user_agent,
        mailto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/autocomplete/funders',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_autocomplete_institutions(
        self,
        q: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
        ...
        _param = self._get_autocomplete_institutions_serialize(
            q=q,
            user_agent=user_agent,
            mailto=mailto,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_autocomplete_institutions_without_preload_content(
        self,
        q: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
    ...
    def _get_autocomplete_institutions_serialize(
        self,
        q,
        user_agent,
        mailto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/autocomplete/institutions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_concept_by_id(
        ...
        _param = self._get_concept_by_id_serialize(
            id=id,
            select=select,
            user_agent=user_agent,
            mailto=mailto,
    ...
    @validate_call
    def get_concept_by_id_without_preload_content(
        self,
        id: Any,
        select: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
    ...
    def _get_concept_by_id_serialize(
        self,
        id,
        select,
        user_agent,
    ...
    def get_concept_by_id_0(
        ...
        _param = self._get_concept_by_id_0_serialize(
            id=id,
            select=select,
            user_agent=user_agent,
            mailto=mailto,
    ...
    @validate_call
    def get_concept_by_id_0_with_http_info(
        self,
        id: Any,
        select: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
    ...
    @validate_call
    def get_concept_by_id_0_without_preload_content(
        self,
        id: Any,
        select: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
    ...
    def _get_concept_by_id_0_serialize(
        self,
        id,
        select,
        user_agent,
    ...
    def get_concepts_0(
        ...
        _param = self._get_concepts_0_serialize(
            api_key=api_key,
            cursor=cursor,
            filter=filter,
            group_by=group_by,
    ...
    @validate_call
    def get_concepts_0_with_http_info(
        self,
        api_key: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,
        filter: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_concepts_0_without_preload_content(
        self,
        api_key: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,
        filter: Optional[StrictStr] = None,
    ...
    def get_domain_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetDomainById200Response]:
        """/domains/{id}
    ...
    def get_field_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFieldById200Response]:
        """/fields/{id}
    ...
    def get_funders(
        ...
        _param = self._get_funders_serialize(
            api_key=api_key,
            cursor=cursor,
            filter=filter,
            group_by=group_by,
    ...
    @validate_call
    def get_funders_with_http_info(
        self,
        api_key: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,
        filter: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_funders_without_preload_content(
        self,
        api_key: Optional[StrictStr] = None,
        cursor: Optional[StrictStr] = None,
        filter: Optional[StrictStr] = None,
    ...
    def get_institutions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InstitutionsResponseSchema]:
        """/institutions
    ...
    def get_person_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PersonResponseSchema]:
        """/people/{id}
    ...
    def get_random_concept_0(
        ...
        _param = self._get_random_concept_0_serialize(
            select=select,
            user_agent=user_agent,
            mailto=mailto,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_random_concept_0_with_http_info(
        self,
        select: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
    ...
    @validate_call
    def get_random_concept_0_without_preload_content(
        self,
        select: Optional[StrictStr] = None,
        user_agent: Annotated[Optional[Any], Field(description="[docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool)")] = None,
        mailto: Annotated[Optional[Any], Field(description="The API is the primary way to get OpenAlex data. It's free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like `mailto:example@domain.com`, or in the User-Agent request header, like `User-Agent: my-app (mailto:example@domain.com)`. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).")] = None,
    ...
    def _get_random_concept_0_serialize(
        self,
        select,
        user_agent,
        mailto,
    ...
    def get_subfield_by_id(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSubfieldById200Response",
            '403': "ErrorMessage",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def get_subfield_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSubfieldById200Response]:
        """/subfields/{id}
    ...
    def get_topic_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTopicById200Response]:
        """/topics/{id}
    ...
    def get_topics_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTopics200Response]:
        """/topics
