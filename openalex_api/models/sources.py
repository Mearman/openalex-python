...
class Sources(BaseModel):
    ...
    Sources
    """ # noqa: E501
    group_by: Optional[List[GroupByResultInner]] = None
    meta: Optional[Meta] = None
    results: Optional[List[SourceSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SourceSchema.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
