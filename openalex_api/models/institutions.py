...
class Institutions(BaseModel):
    ...
    meta: Meta
    results: Optional[List[InstitutionSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [InstitutionSchema.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
