...
class RepositoriesArrayInner(BaseModel):
    """
    RepositoriesArrayInner
    """ # noqa: E501
    display_name: StrictStr
    host_organization: StrictStr
    host_organization_lineage: List[StrictStr]
    host_organization_name: StrictStr
    id: StrictStr
    __properties: ClassVar[List[str]] = ["display_name", "host_organization", "host_organization_lineage", "host_organization_name", "id"]
