...
class AffiliationsInner(BaseModel):
    """
    AffiliationsInner
    """ # noqa: E501
    institution: DehydratedInstitution
    years: List[StrictInt]
    __properties: ClassVar[List[str]] = ["institution", "years"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "institution": DehydratedInstitution.from_dict(obj.get("institution")) if obj.get("institution") is not None else None,
            "years": obj.get("years")
        })
        return _obj
