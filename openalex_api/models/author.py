...
class Author(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "affiliations": [AffiliationsInner.from_dict(_item) for _item in obj["affiliations"]] if obj.get("affiliations") is not None else None,
            ...
            "last_known_institution": DehydratedInstitution.from_dict(obj["last_known_institution"]) if obj.get("last_known_institution") is not None else None,
            "last_known_institutions": [DehydratedInstitution.from_dict(_item) for _item in obj["last_known_institutions"]] if obj.get("last_known_institutions") is not None else None,
            "orcid": obj.get("orcid"),
