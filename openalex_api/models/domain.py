...
class Domain(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cited_by_count", "created_date", "description", "display_name", "display_name_alternatives", "fields", "id", "ids", "siblings", "updated_date", "works_api_url", "works_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": TopicLevelArraySchema.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
            "id": obj.get("id"),
