...
class InternationalDisplayNameAndDescription(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "description": InternationalDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "display_name": InternationalDisplayName.from_dict(obj["display_name"]) if obj.get("display_name") is not None else None
        })
        return _obj
