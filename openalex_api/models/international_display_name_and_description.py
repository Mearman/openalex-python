...
class InternationalDisplayNameAndDescription(BaseModel):
    """
    InternationalDisplayNameAndDescription
    """ # noqa: E501
    description: Optional[InternationalDescription] = None
    display_name: Optional[InternationalDisplayName] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "description": InternationalDescription.from_dict(obj.get("description")) if obj.get("description") is not None else None,
            "display_name": InternationalDisplayName.from_dict(obj.get("display_name")) if obj.get("display_name") is not None else None
        })
        return _obj
