...
class Concept(BaseModel):
    ...
    Concept
    """ # noqa: E501
    ancestors: Optional[List[DehydratedConcept]] = None
    ...
    related_concepts: Optional[List[DehydratedConcept]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ancestors": [DehydratedConcept.from_dict(_item) for _item in obj["ancestors"]] if obj.get("ancestors") is not None else None,
            ...
            "id": obj.get("id"),
            "ids": ConceptIds.from_dict(obj["ids"]) if obj.get("ids") is not None else None,
            "image_thumbnail_url": obj.get("image_thumbnail_url"),
            "image_url": obj.get("image_url"),
            "international": InternationalDisplayNameAndDescription.from_dict(obj["international"]) if obj.get("international") is not None else None,
            "level": obj.get("level"),
            "related_concepts": [DehydratedConcept.from_dict(_item) for _item in obj["related_concepts"]] if obj.get("related_concepts") is not None else None,
