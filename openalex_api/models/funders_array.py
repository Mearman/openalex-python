...
class FundersArray(BaseModel):
    """
    FundersArray
    """ # noqa: E501
    group_by: List[GroupByResultInner]
    meta: Meta
    results: Optional[List[FunderSchema]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [FunderSchema.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
