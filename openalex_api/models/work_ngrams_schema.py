...
class WorkNgramsSchema(BaseModel):
    """
    WorkNgramsSchema
    """ # noqa: E501
    meta: Optional[NgramMeta] = None
    ngrams: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ngrams (nullable) is None
        # and model_fields_set contains the field
        if self.ngrams is None and "ngrams" in self.model_fields_set:
            _dict['ngrams'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "meta": NgramMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "ngrams": obj.get("ngrams")
        })
        return _obj
