...
class PublisherSchema(BaseModel):
    ...
    PublisherSchema
    """ # noqa: E501
    alternate_titles: Optional[List[StrictStr]] = None
    ...
    sources_api_url: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent_publisher": PublisherParentPublisher.from_dict(obj["parent_publisher"]) if obj.get("parent_publisher") is not None else None,
