...
class PublisherSchema(BaseModel):
    ...
    parent_publisher: Optional[PublisherSchemaParentPublisher] = None
    ...
    __properties: ClassVar[List[str]] = ["alternate_titles", "cited_by_count", "country_codes", "counts_by_year", "created_date", "display_name", "hierarchy_level", "homepage_url", "id", "ids", "image_thumbnail_url", "image_url", "lineage", "parent_publisher", "roles", "sources_api_url", "summary_stats", "updated_date", "works_count"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.sources_api_url is None and "sources_api_url" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "parent_publisher": PublisherSchemaParentPublisher.from_dict(obj.get("parent_publisher")) if obj.get("parent_publisher") is not None else None,
            "roles": obj.get("roles"),
