...
class GetTopics200ResponseMeta(BaseModel):
    """
    GetTopics200ResponseMeta
    """ # noqa: E501
    count: Optional[Any]
    db_response_time_ms: Optional[Any]
    groups_count: Optional[Any]
    page: Optional[Any]
    per_page: Optional[Any]
    __properties: ClassVar[List[str]] = ["count", "db_response_time_ms", "groups_count", "page", "per_page"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.db_response_time_ms is None and "db_response_time_ms" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.per_page is None and "per_page" in self.model_fields_set:
            _dict['per_page'] = None
