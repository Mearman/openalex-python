...
class Topic(BaseModel):
    ...
    var_field: TopicLevelArraySchema = Field(alias="field")
    id: StrictStr
    ids: Ids
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "domain": TopicLevelArraySchema.from_dict(obj["domain"]) if obj.get("domain") is not None else None,
            "field": TopicLevelArraySchema.from_dict(obj["field"]) if obj.get("field") is not None else None,
            "id": obj.get("id"),
            "ids": Ids.from_dict(obj["ids"]) if obj.get("ids") is not None else None,
            "keywords": obj.get("keywords"),
            "siblings": TopicLevelSchema.from_dict(obj["siblings"]) if obj.get("siblings") is not None else None,
            "subfield": TopicLevelArraySchema.from_dict(obj["subfield"]) if obj.get("subfield") is not None else None,
