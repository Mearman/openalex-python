...
class Topics(BaseModel):
    ...
    meta: TopicsMeta
    results: Optional[List[TopicsResultsInner]] = None
    __properties: ClassVar[List[str]] = ["group_by", "meta", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group_by": [GroupByResultInner.from_dict(_item) for _item in obj["group_by"]] if obj.get("group_by") is not None else None,
            "meta": TopicsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "results": [TopicsResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
