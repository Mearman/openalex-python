...
class TopicsResultsInner(BaseModel):
    """
    TopicsResultsInner
    """ # noqa: E501
    ...
    domain: Optional[TopicLevelSchema] = None
    var_field: Optional[TopicLevelSchema] = Field(default=None, alias="field")
    id: StrictStr
    ids: Optional[Ids] = None
    keywords: Optional[List[StrictStr]] = None
    relevance_score: Optional[Union[StrictFloat, StrictInt]] = None
    siblings: Optional[TopicLevelArraySchema] = None
    subfield: Optional[TopicLevelSchema] = None
    updated_date: Optional[StrictStr] = None
    works_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["cited_by_count", "created_date", "description", "display_name", "domain", "field", "id", "ids", "keywords", "relevance_score", "siblings", "subfield", "updated_date", "works_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subfield": TopicLevelSchema.from_dict(obj["subfield"]) if obj.get("subfield") is not None else None,
